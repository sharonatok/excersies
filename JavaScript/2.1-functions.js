...
let aboutIsrael = describeCountry("Israel"," 6 million", "Jerusalem")
let aboutGermany = describeCountry("Germany", "83 nillion", "Berlin")
let aboutUnitedStates = describeCountry("United States",  "331 nillion", "Washington")
console.log(aboutIsrael)
console.log(aboutGermany)
console.log(aboutUnitedStates)