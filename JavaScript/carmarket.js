const carMarket = {
  ...
  //   const agency1 = this.sellers.find((agencyObject) => {
...
//     const agency2 = this.sellers.find((agencyObject) => {
//         return (name === agencyObject.agencyName);
//     });
//     // if (agency) {                //  or trinary :   return agency ? agency.agencyId : undefined;
//     //     return agency.angecyId;   // or conditional abuse: return agency && agency.agencyId;- falsyאם זה נכון מחזיר את הראשון אם לא אז את השני משתמשים במיוחד אם אחת מהאפשרויות ידוע כ
//     // }                             //
//     // return undefined;
//     return agency2 ? agency2.agencyId : agency2;
//    };
...
// console.log(carMarket.getAllBrandsToBuyAgencyId(carMarket, "Plyq5M5AZ"));
  ...
  //? @return {Object} - customer
    ...
    //  carMarket.getCustomerByName = function (name1) {
    //   const customerName = this.customers.find((customerObject) => {
    //               return name1 === customerObject.name});
    //             return customerName;
    //       };
  ...
  // carMarket.getCustomerIdByName = function(name2) {
  //       const customerName2 = this.customers.find((customerObject) => {
  //           return (name2 === customerObject.name);
  //       });
  //       return customerName2 ? customerName2.id : customerName2;
  //      };
  //      console.log(carMarket.getCustomerIdByName("Aleksander Carr"));
...
//   for (const customerName of carMarket.customers) {
//     customersNameArr.push(customerName.name);
//   }
